...
export function AcademicProvider({ children }: { children: ReactNode }) {
  ...
  const currentProgressRead = profile.progress[profile.major];
  const completedCoursesArr = currentProgressRead?.completedCourses;
  const inProgressCoursesArr = currentProgressRead?.inProgressCourses;
