...
export function AcademicProvider({ children }: { children: ReactNode }) {
  ...
  // Extract arrays to satisfy exhaustive-deps and prevent unnecessary recalculations
  ...
  }, [courseMap, profile, completedSet]);
  ...
  const getCourseStatus = useCallback((courseId: string): CourseStatus => {
    ...
    return 'locked';
  }, [profile, arePrereqsMet, completedSet, inProgressSet]);
