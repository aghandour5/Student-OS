...
export default function DashboardScreen() {
  ...
  // ⚡ Bolt Optimization: Batching course filtering
  // Replaces 4 separate O(N) .filter passes with a single O(N) pass inside useMemo.
  // Reduces getCourseStatus evaluations by 75% and prevents redundant calculations on re-render.
