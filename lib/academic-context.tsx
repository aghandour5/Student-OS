...
export function AcademicProvider({ children }: { children: ReactNode }) {
  ...
  const completedSet = useMemo(() => new Set(completedCoursesList || []), [completedCoursesList]);
  const inProgressSet = useMemo(() => new Set(inProgressCoursesList || []), [inProgressCoursesList]);
